                ...
                <?php foreach($eventos as $evento) { ?>
                        <tr class="table__tr">
                            ...
                            <td class="table__td--acciones">
                                <a class="table__accion table__accion--ediftar" href="/admin/eventos/editar?id=<?php echo $evento->id ?>">
                                ...
                                <form class="table__formulario" method="POST" action="/admin/eventos/eliminar">
                                    ...
                                    <button class="table__accion table__accion--eliminar" type="submit" class="table__accion table__accion--eliminar">
